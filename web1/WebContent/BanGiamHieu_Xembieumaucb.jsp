		...
		<div class="col-md-12 ">
			<div class="row ">	
				<div class="btn-group-vertical">
					...
					<button type="button" class="btn btn-default active" style="width:100%" onclick="window.location.href='BanGiamHieu_Xembieumaucb.jsp'">
						<div class="danhmuc" style="float:left">Xem biểu mẫu cán bộ</div>
					</button>
					<button type="button" class="btn btn-default" style="width:100% " onclick="window.location.href='BanGiamHieu_Bieumautruongkhoa.jsp'">
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>Trưởng khoa</td>
							<td>CNTT</td>
							<td class="text-center"> <a href="BanGiamHieu_Bieumaudadk.jsp">Xem</a> </td>
							<td class="text-center"> <a href="BanGiamHieu_Bieumaudadanhgia.jsp">Xem</a></td>
						</tr>
						<tr>
							<td>333</td>
							<td>Nguyễn Văn B</td>
