			...
			<div class="col-md-9">
				<div class="container4">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#home">Duyệt biểu mẫu đã đăng ký của GV</a></li>
						<li><a data-toggle="tab" href="#menu1">Duyệt biểu mẫu đã đánh giá của GV</a></li>
					</ul>
					...
					<div class="row">
						<div class="col-md-12 col-md-offset-8">
							...
							<button class="btn btn-primary"
								onclick="window.location.href='TruongKhoa_Bieumaugiangvien.jsp'">Quay về</button>
						</div>
					</div>
				</div>
			</div>
