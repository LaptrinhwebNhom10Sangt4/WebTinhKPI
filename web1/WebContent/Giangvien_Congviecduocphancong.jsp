					...
					<div style="overflow-x: auto;">
						<form action="updateCV" method="get">
							...
							<input name="quantity" type="hidden" value=<%=rowCount%> /> <input
								name="MaKhoa" type="hidden" value=${MaKhoa } /> <input
								name="email" type="hidden" value=${email } /> <input name="url"
								type="hidden" value="Giangvien_Congviecduocphancong.jsp" />
							<table>
								<thead>
									<tr>
												...
												<div style="witdh: 200px" class="well">
													<table>
														...
														<tr>
															...
															%>
															<td><input name=<%=count1%> value=<%=form1[row][1]%>
																type="checkbox" <%=checked%> <%=disable%> /></td>
															<%
																count1++;
																						continue;
																					}
