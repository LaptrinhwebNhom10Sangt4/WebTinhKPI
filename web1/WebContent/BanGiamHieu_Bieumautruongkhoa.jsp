...
<div class="col-md-9">
		<div class="container4">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#home">Duyệt biểu mẫu đã đăng ký của trưởng khoa</a></li>
				<li><a data-toggle="tab" href="#menu1">Duyệt biểu mẫu đã đánh giá của trưởng khoa</a></li>
			</ul>

			<div class="tab-content">
				<div id="home" class="tab-pane fade in active">
					<div class="container4" style="padding-top: 50px;padding-left: 10px">
						<table>
