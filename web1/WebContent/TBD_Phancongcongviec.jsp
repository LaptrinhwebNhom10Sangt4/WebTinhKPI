		...
		<div class="col-md-12 ">
			<div class="row ">	
				<div class="btn-group-vertical">
					...
					<button type="button" class="btn btn-default" style="width:100% " onclick="window.location.href='TBD_Quanlybieumaudadk.jsp'">
				...
				<button type="button" class="btn btn-default active" style="width:100% " onclick="window.location.href='TBD_Phancongcongviec.jsp'"">
	...
	<div class="container4">
		...
		<div class="row">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#home">Phân công</a></li>
				...
				<div class="tab-content">
					<div id="home" class="tab-pane fade in active">
						<table>
							...
							<tr>
								<td>
									<select class="dropdown semi-square" id="cboRole" style="color: 000000; height: 30px">
					...
					<div id="menu1" class="tab-pane fade">
						<table>
							...
							<tr>
								...
								<td>
									Phổ biến sd KPI cho GV
								</td>
								<td>
									Nguyễn Văn A
								</td>
								<td>
									10/9/2016-21/12/2016
								</td>
								<td>
						...
						<div class="row" style="padding-top:10px">
							<div class="col-md-12 col-md-offset-8">
								<div class="btn-group" >
									<button type="button" class="btn btn-primary" onClick="javascript:open_window('TBD_TaoCV.jsp',600,600);" >Tạo công việc</button>
									<button type="button" class="btn btn-primary">Xóa công việc</button>
								</div>
							</div>
						</div>
					</div>
