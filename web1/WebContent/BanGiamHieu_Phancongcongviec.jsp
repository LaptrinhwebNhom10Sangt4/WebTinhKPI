		...
		<div class="row ">
			<div class="col-md-3">
				<div class="col-md-12 ">
					...
					<button type="button" class="btn btn-default active" style="width:100% " onclick="window.location.href='BanGiamHieu_Phancongcongviec.jsp'"">
						...
						<div class="row">
							<div class="col-sm-3 col-sm-offset-9">
								<div class="btn-group" role="group">
									<button type="button" class="btn btn-primary">Phân công</button>
